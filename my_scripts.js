...
function loadPlayersPage(){
	...
	//for(int i = 0; i < players.length; i++){
		//aTag = '<p><a href = # onclick=switchPlayers(' + i +')>' + players[i].name + '</a></p>';
		//text = text + aTag;
	//}
	//menu.innerHTML = text;
	...
	for(var i = 0; i < players.length; i++){
		...
		p.innerHTML += '<a class = "dropdown-item" href = "#" onclick = "switchPlayers(' + i + ')">'+pName+'</a';
	}
}
...
function switchPlayers(playerNum){
	...
	document.getElementById("player_img").alt = "Player Pic";
